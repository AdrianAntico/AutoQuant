...
if(!is.null(RemixOutput)) {
  ...
  ## ROCPlot ----
  Test_ROCPlot <- RemixOutput[['PlotList']][['Test_ROC_Plot']]
  Train_ROCPlot <- RemixOutput[['PlotList']][['Train_ROC_Plot']]
  
  ## Cumulative Gains Plot ----
  Test_CumGainsChart <- list()
  Train_CumGainsChart <- list()
  
  Test_CumGainsChart[['GainsPlot']] <- RemixOutput[['PlotList']][['Test_GainsPlot']]
  Test_CumGainsChart[['LiftPlot']] <- RemixOutput[['PlotList']][['Test_LiftPlot']]
  
  Train_CumGainsChart[['GainsPlot']] <- RemixOutput[['PlotList']][['Train_GainsPlot']]
  Train_CumGainsChart[['LiftPlot']] <- RemixOutput[['PlotList']][['Train_LiftPlot']]
}
```  
  ...
  if(!is.null(TestData) && !is.null(AddPDPList_Line)) {
    for(g in AddPDPList_Line) {
      if(is.numeric(TestData[[g]])) {
        ...
        # Add
        Test_ParDepPlots[[g]] <- AutoQuant::ParDepCalPlots(
          data = TestData, 
  ...
  if(!is.null(TrainData) && !is.null(AddPDPList_Line)) {
    for(g in AddPDPList_Line) {
      if(is.numeric(TrainData[[g]])) {
        ...
        # Add
        Train_ParDepPlots[[g]] <- AutoQuant::ParDepCalPlots(
          data = TrainData, 
          PredictionColName = 'p1', 
          TargetColName = TargetColumnName, 
          IndepVar = g, 
  ...
  if(!is.null(TestData) && !is.null(AddPDPList_Box)) {
    for(g in AddPDPList_Box) {
      if(is.numeric(TestData[[g]])) {
        ...
        # Add
        Test_ParDepBoxPlots[[g]] <- AutoQuant::ParDepCalPlots(
          data = TestData, 
          PredictionColName = 'p1', 
          TargetColName = TargetColumnName, 
          IndepVar = g, 
  ...
  if(!is.null(TrainData) && !is.null(AddPDPList_Box)) {
    for(g in AddPDPList_Box) {
      if(is.numeric(TrainData[[g]])) {
        ...
        # Add
        Train_ParDepBoxPlots[[g]] <- AutoQuant::ParDepCalPlots(
          data = TrainData, 
          PredictionColName = 'p1', 
          TargetColName = TargetColumnName, 
          IndepVar = g, 
  ...
  if(!is.null(TestData) && !is.null(AddPDPList_Bar)) {
    for(g in AddPDPList_Bar) {
      if(!is.numeric(TestData[[g]])) {
        ...
        # Add
        Test_ParDepCatPlots[[g]] <- AutoQuant::ParDepCalPlots(
          data = TestData, 
          PredictionColName = 'p1', 
          TargetColName = TargetColumnName, 
          IndepVar = g, 
  ...
  if(!is.null(TrainData) && !is.null(AddPDPList_Bar)) {
    for(g in AddPDPList_Bar) {
      if(!is.numeric(TrainData[[g]])) {
        ...
        # Add
        Train_ParDepCatPlots[[g]] <- AutoQuant::ParDepCalPlots(
          data = TrainData, 
          PredictionColName = 'p1', 
          TargetColName = TargetColumnName, 
          IndepVar = g, 
...
if(is.null(RemixOutput)) {
  ...
  ### Test ----
  if(!is.null(TestData)) {
    Test_EvaluationPlot <- AutoQuant::EvalPlot(
  ...
  if(!is.null(TrainData)) {
    Train_EvaluationPlot <- AutoQuant::EvalPlot(
  ...
  ### TestData ----
  if(!is.null(TestData)) {
    Test_ROCPlot <- AutoQuant::ROCPlot(
      data = TestData,
  ...
  ### TrainData ----
  if(!is.null(TrainData)) {
    Train_ROCPlot <- AutoQuant::ROCPlot(
      data = TrainData,
      TargetName = TargetColumnName,
      SavePlot = FALSE,
      Name = ModelID,
  ...
  ## Test_CumGainsChart ----
  if(!is.null(TestData)) {
    Test_CumGainsChart <- AutoQuant::CumGainsChart(
      data = data.table::copy(TestData),
  ...
  ## Train_CumGainsChart ----
  if(!is.null(TrainData)) {
    Train_CumGainsChart <- AutoQuant::CumGainsChart(
      data = data.table::copy(TrainData),
      PredictedColumnName = 'p1',
      TargetColumnName = TargetColumnName,
      NumBins = 20,
...
if(!is.null(Test_Importance)) {
  ...
  eval(AutoQuant:::PlotlyConversion(AutoQuant:::VI_Plot(Type = 'catboost', VI_Data = Test_Importance, TopN = 15)))
} else {
...
if(!is.null(Validation_Importance)) {
  ...
  eval(AutoQuant:::PlotlyConversion(AutoQuant:::VI_Plot(Type = 'catboost', VI_Data = Validation_Importance, TopN = 15)))
} else {
...
if(!is.null(Train_Importance)) {
  ...
  eval(AutoQuant:::PlotlyConversion(AutoQuant:::VI_Plot(Type = 'catboost', VI_Data = Train_Importance, TopN = 15)))
} else {
...
if(!is.null(Test_EvaluationPlot)) {
  eval(AutoQuant:::PlotlyConversion(Test_EvaluationPlot))
} else {
...
if(!is.null(Train_EvaluationPlot)) {
  eval(AutoQuant:::PlotlyConversion(Train_EvaluationPlot))
} else {
...
if(!is.null(Test_ROCPlot)) {
  eval(AutoQuant:::PlotlyConversion(Test_ROCPlot))
} else {
  print('Test_ROCPlot is NULL or TestData is NULL')
}
print('Train + Validation Data Evaluation Plot')
if(!is.null(Train_EvaluationPlot)) {
  eval(AutoQuant:::PlotlyConversion(Train_ROCPlot))
} else {
...
if(!is.null(Test_CumGainsChart)) {
  eval(AutoQuant:::PlotlyConversion(Test_CumGainsChart))
} else {
  print('Test_CumGainsChart is NULL or TestData is NULL')
}
print('Train + Validation Data Lift and Gains Plots')
if(!is.null(Test_CumGainsChart)) {
  eval(AutoQuant:::PlotlyConversion(Train_CumGainsChart))
} else {
