...
if(is.null(RemixOutput)) {
  ...
  if(!is.null(TestData) && !file.exists(file.path(SourcePath, paste0(ModelID, "_Test_EvaluationMetrics.csv")))) {
    Test_EvalMetrics <- RemixAutoML:::ClassificationMetrics(
      TestData = TestData,
  ...
  if(!is.null(TrainData) && !file.exists(file.path(SourcePath, paste0(ModelID, "_Train_EvaluationMetrics.csv")))) {
    Train_EvalMetrics <- RemixAutoML:::ClassificationMetrics(
      TestData = TrainData,
      Thresholds = seq(0,1,0.01),
      Target = TargetColumnName,
      PredictColumnName = 'p1',
...
if(!is.null(Test_EvalMetrics)) {
  print(RemixAutoML::DataTable(Test_EvalMetrics))
} else {
...
if(!is.null(Train_EvalMetrics)) {
  print(RemixAutoML::DataTable(Train_EvalMetrics))
} else {
...
if(!is.null(All_Importance)) {
  ...
  print(RemixAutoML::DataTable(All_Importance))
} else {
...
if(!is.null(All_Interaction)) {
  ...
  print(RemixAutoML::DataTable(All_Interaction))
} else {
...
if(!is.null(Test_Importance)) {
  ...
  eval(RemixAutoML:::PlotlyConversion(RemixAutoML:::VI_Plot(Type = 'catboost', VI_Data = Test_Importance, TopN = 15)))
} else {
...
if(!is.null(Validation_Importance)) {
  ...
  eval(RemixAutoML:::PlotlyConversion(RemixAutoML:::VI_Plot(Type = 'catboost', VI_Data = Validation_Importance, TopN = 15)))
} else {
...
if(!is.null(Train_Importance)) {
  ...
  eval(RemixAutoML:::PlotlyConversion(RemixAutoML:::VI_Plot(Type = 'catboost', VI_Data = Train_Importance, TopN = 15)))
} else {
...
if(!is.null(Test_EvaluationPlot)) {
  eval(RemixAutoML:::PlotlyConversion(Test_EvaluationPlot))
} else {
...
if(!is.null(Train_EvaluationPlot)) {
  eval(RemixAutoML:::PlotlyConversion(Train_EvaluationPlot))
} else {
...
if(!is.null(Test_ROCPlot)) {
  eval(RemixAutoML:::PlotlyConversion(Test_ROCPlot))
} else {
  print('Test_ROCPlot is NULL or TestData is NULL')
}
print('Train + Validation Data Evaluation Plot')
if(!is.null(Train_EvaluationPlot)) {
  eval(RemixAutoML:::PlotlyConversion(Train_ROCPlot))
} else {
...
if(!is.null(Test_CumGainsChart)) {
  eval(RemixAutoML:::PlotlyConversion(Test_CumGainsChart))
} else {
  print('Test_CumGainsChart is NULL or TestData is NULL')
}
print('Train + Validation Data Lift and Gains Plots')
if(!is.null(Test_CumGainsChart)) {
  eval(RemixAutoML:::PlotlyConversion(Train_CumGainsChart))
} else {
