...
## EvaluationPlots_prROC_Plot ----

### TestData ----
if(!is.null(TestData)) {
  Test_prROCPlot <- AutoPlots::Plot.prROC(
    dt = TestData,
    SampleSize = 500000,
    XVar = PredictionColumnName,
    YVar = TargetColumnName,
...
### TrainData ----
if(!is.null(TrainData)) {
  Train_prROCPlot <- AutoPlots::Plot.prROC(
    dt = TrainData,
    SampleSize = 500000,
    XVar = PredictionColumnName,
    YVar = TargetColumnName,
...
## <font size="5">prROC Plots</font>
<p>

<details><summary>Expand</summary>
<p>

```{r prROC_Plot, echo=FALSE}
if(!is.null(Test_prROCPlot)) {
  Test_prROCPlot
} else {
  print('Test_prROCPlot is NULL or TestData is NULL')
}
if(!is.null(Train_EvaluationPlot)) {
  Train_prROCPlot
}
