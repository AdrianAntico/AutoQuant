...
body {
  ...
  color: var(--text);
  background: radial-gradient(1200px 600px at 20% -10%, rgba(72,145,255,0.20), transparent 60%),
...
Test_ResidualHistogram <- AutoPlots::Plot.Residuals.Histogram(
  ...
  Height = "600px",
  Width = "975px",
  Title = "Residuals Histogram: Test Data",
  ShowLabels = FALSE,
...
if(length(TrainData) > 0L) {
  Train_ResidualHistogram <- AutoPlots::Plot.Residuals.Histogram(
    ...
    Height = "600px",
    Width = "975px",
    Title = "Residuals Histogram: Train Data",
    ShowLabels = FALSE,
    Title.YAxis = TargetColumnName,
    Title.XAxis = 'Predict',
    EchartsTheme = "wef",
...
Test_EvaluationPlot <- AutoPlots::Plot.Calibration.Line(
  ...
  Height = "600px",
  Width = "975px",
  Title = "Calibration Line Plot: Test Data",
  ShowLabels = FALSE,
  Title.YAxis = TargetColumnName,
  Title.XAxis = "Predict",
  EchartsTheme = "wef",
...
if(!is.null(TrainData)) {
  Train_EvaluationPlot <- AutoPlots::Plot.Calibration.Line(
    ...
    Height = "600px",
    Width = "975px",
    Title = "Calibration Line Plot: Train Data",
    Title.YAxis = TargetColumnName,
    Title.XAxis = "Predict",
    EchartsTheme = "wef",
    TimeLine = TRUE,
  ...
  for(g in FeatureColumnNames) {
    if(is.character(TestData[[g]]) || is.factor(TestData[[g]])) {
      Test_ParDepCatPlots[[g]] <- tryCatch({AutoPlots::Plot.PartialDependence.HeatMap(
        ...
        Height = "600px",
        Width = "975px",
        Title = "Partial Dependence Bar Plot: Test Data",
        ShowLabels = FALSE,
        Title.YAxis = TargetColumnName,
        Title.XAxis = g,
        EchartsTheme = "wef",
  ...
  for(g in FeatureColumnNames) {
    if(is.character(TrainData[[g]]) || is.factor(TrainData[[g]])) {
      Train_ParDepCatPlots[[g]] <- tryCatch({AutoPlots::Plot.PartialDependence.HeatMap(
        ...
        Height = "600px",
        Width = "975px",
        Title = "Partial Dependence Bar Plot: Train Data",
        ShowLabels = FALSE,
        Title.YAxis = TargetColumnName,
        Title.XAxis = g,
        EchartsTheme = "wef",
