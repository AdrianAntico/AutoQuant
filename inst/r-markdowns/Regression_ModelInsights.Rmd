...
if(!is.null(Test_EvaluationBoxPlot)) {
  eval(RemixAutoML:::PlotlyConversion(Test_EvaluationBoxPlot))
} else {
...
if(!is.null(Train_EvaluationBoxPlot)) {
  eval(RemixAutoML:::PlotlyConversion(Train_EvaluationBoxPlot))
} else {
