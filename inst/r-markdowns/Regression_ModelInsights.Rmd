...
### Test
Test_ResidualHistogram <- AutoPlots::Residuals.Histogram(
  dt = TestData,
  AggMethod = "mean",
  SampleSize = 100000,
  ...
  NumberBins = 20,
  title.text = "Residuals Histogram: Test Data",
  yAxis.title = TargetColumnName,
  xAxis.title = PredictionColumnName,
  Theme = "dark",
  TimeLine = FALSE
)
...
if(length(TrainData) > 0L) {
  Train_ResidualHistogram <- AutoPlots::Residuals.Histogram(
    dt = TrainData,
    AggMethod = "mean",
    SampleSize = 100000,
    XVar = PredictionColumnName,
    YVar = TargetColumnName,
    NumberBins = 20,
    title.text = "Residuals Histogram: Train Data",
    yAxis.title = TargetColumnName,
    xAxis.title = 'Predict',
    Theme = "dark",
    TimeLine = FALSE
...
### Test
Test_EvaluationPlot <- AutoPlots::Calibration.Line(
  dt = TestData,
  AggMethod = "mean",
  XVar = PredictionColumnName,
  YVar = TargetColumnName,
  NumberBins = 21,
  title.text = "Calibration Line Plot: Test Data",
  yAxis.title = TargetColumnName,
  xAxis.title = "Predict",
  Theme = "dark",
  TimeLine = TRUE
...
if(!is.null(TrainData)) {
  Train_EvaluationPlot <- AutoPlots::Calibration.Line(
    dt = TrainData,
    AggMethod = "mean",
    XVar = PredictionColumnName,
    YVar = TargetColumnName,
    NumberBins = 21,
    title.text = "Calibration Line Plot: Train Data",
    yAxis.title = TargetColumnName,
    xAxis.title = "Predict",
    Theme = "dark",
    TimeLine = TRUE
...
### Test
Test_EvaluationBoxPlot <- AutoPlots::Calibration.Box(
  dt = TestData,
  SampleSize = 100000L,
  AggMethod = "mean",
  XVar = PredictionColumnName,
  YVar = TargetColumnName,
  NumberBins = 21,
  title.text = "Calibration Plot: Test Data",
  yAxis.title = TargetColumnName,
  xAxis.title = "Predict",
  Theme = "dark",
  TimeLine = TRUE
...
### Train
if(!is.null(TrainData)) {
  Train_EvaluationBoxPlot <- AutoPlots::Calibration.Box(
    dt = TrainData,
    SampleSize = 100000L,
    AggMethod = "mean",
    XVar = PredictionColumnName,
    YVar = TargetColumnName,
    NumberBins = 21,
    title.text = "Calibration Plot: Train Data",
    yAxis.title = TargetColumnName,
    xAxis.title = "Predict",
    Theme = "dark",
    TimeLine = TRUE
...
if(!is.null(TestData) && !is.null(FeatureColumnNames)) {
  for(g in FeatureColumnNames) {
    if(is.numeric(TestData[[g]])) {
      Test_ParDepPlots[[g]] <- tryCatch({AutoPlots::PartialDependence.Line(
        dt = TestData,
        XVar = g,
        YVar = TargetColumnName,
        ZVar = 'Predict',
        NumberBins = 20,
        AggMethod = "mean",
        title.text = "Partial Dependence Line: Test Data",
        yAxis.title = TargetColumnName,
        xAxis.title = g,
        Theme = "dark",
        TimeLine = TRUE
...
if(!is.null(TrainData) && !is.null(FeatureColumnNames)) {
  for(g in FeatureColumnNames) {
    if(is.numeric(TrainData[[g]])) {
      Train_ParDepPlots[[g]] <- tryCatch({AutoPlots::PartialDependence.Line(
        dt = TrainData,
        XVar = g,
        YVar = TargetColumnName,
        ZVar = 'Predict',
        NumberBins = 20,
        AggMethod = "mean",
        title.text = "Partial Dependence Line: Train Data",
        yAxis.title = TargetColumnName,
        xAxis.title = g,
        Theme = "dark",
        TimeLine = TRUE
...
if(!is.null(TestData) && !is.null(FeatureColumnNames)) {
  for(g in FeatureColumnNames) {
    if(is.numeric(TestData[[g]])) {
      Test_ParDepBoxPlots[[g]] <- tryCatch({AutoPlots::PartialDependence.Box(
        dt = TestData,
        XVar = g,
        YVar = TargetColumnName,
        ZVar = 'Predict',
...
if(!is.null(TrainData) && !is.null(FeatureColumnNames)) {
  for(g in FeatureColumnNames) {
    if(is.numeric(TrainData[[g]])) {
      Train_ParDepBoxPlots[[g]] <- tryCatch({AutoPlots::PartialDependence.Box(
        dt = TrainData,
        XVar = g,
        YVar = TargetColumnName,
        ZVar = 'Predict',
...
if(!is.null(TestData) && !is.null(FeatureColumnNames)) {
  for(g in FeatureColumnNames) {
    if(is.character(TestData[[g]]) || is.factor(TestData[[g]])) {
      Test_ParDepCatPlots[[g]] <- tryCatch({AutoPlots::PartialDependence.HeatMap(
        dt = TestData,
        XVar = g,
        YVar = TargetColumnName,
        ZVar = 'Predict',
        NumberBins = 20,
        AggMethod = "mean",
        title.text = "Partial Dependence Bar Plot: Test Data",
        yAxis.title = TargetColumnName,
        xAxis.title = g,
        Theme = "dark",
        TimeLine = TRUE
...
if(!is.null(TrainData) && !is.null(FeatureColumnNames)) {
  for(g in FeatureColumnNames) {
    if(is.character(TrainData[[g]]) || is.factor(TrainData[[g]])) {
      Train_ParDepCatPlots[[g]] <- tryCatch({AutoPlots::PartialDependence.HeatMap(
        dt = TrainData,
        XVar = g,
        YVar = TargetColumnName,
        ZVar = 'Predict',
        NumberBins = 20,
        AggMethod = "mean",
        title.text = "Partial Dependence Bar Plot: Train Data",
        yAxis.title = TargetColumnName,
        xAxis.title = g,
        Theme = "dark",
        TimeLine = TRUE
...
<summary>Model Metrics Tables</summary>
...
<summary>Variable Importance Table</summary>
...
<summary>Interaction Importance Tables</summary>
...
if(!is.null(Test_Importance)) {
  ...
  AutoPlots::VariableImportance(
    ...
    YVar = "Variable",
    AggMethod = "mean",
    title.text = "Variable Importance Plot: Test Data",
    xAxis.title = NULL,
    Theme = "dark",
    TimeLine = FALSE
  )
} else {
  print("Test Importance is NULL")
}
if(!is.null(Validation_Importance)) {
  ...
  AutoPlots::VariableImportance(
    ...
    YVar = "Variable",
    AggMethod = "mean",
    title.text = "Variable Importance Plot: Validation Data",
    xAxis.title = NULL,
    Theme = "dark",
    TimeLine = FALSE
  )
...
if(!is.null(Train_Importance)) {
  ...
  AutoPlots::VariableImportance(
    ...
    YVar = "Variable",
    AggMethod = "mean",
    title.text = "Variable Importance Plot: Train Data",
    xAxis.title = NULL,
    Theme = "dark",
    TimeLine = FALSE
  )
...
<summary>Partital Dependence Line Plots</summary>
...
if(!is.null(Train_ParDepPlots) && length(Train_ParDepPlots) > 0) {
  ...
  print('TrainData was not supplied')
}
options(warn = 1)
```
...
<summary>Partital Dependence Box Plots</summary>
...
<summary>Partital Dependence Bar Plots</summary>
...
<summary>Grid Tuning Metrics</summary>
