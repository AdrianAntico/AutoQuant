#' AutoH2oMLMultiClass is an automated H2O modeling framework with grid-tuning and model evaluation
#'
...
#' 
#' # Run function
#' TestModel <- AutoH2oMLMultiClass(data,
#'                                   TrainOnFull = FALSE,
#'                                   ValidationData = NULL,
#'                                   TestData = NULL,
...
#' @export
AutoH2oMLMultiClass <- function(data,
                                TrainOnFull = FALSE,
                                ValidationData = NULL,
                                TestData = NULL,
