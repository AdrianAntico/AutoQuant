...
#' H2oMLResults$ModelInformation$EvaluationMetricsByGroup[order(MSE_Metric)]
#' H2oMLResults$ModelInformation$EvaluationMetricsByGroup[order(MAPE_Metric)]
#' }
...
AutoH2oMLCARMA <- function(data,
  ...
  # Run AutoH2oMLRegression and return list of ml objects
