...
qa_autoquant_package <- function() {
  ...
  qa_results <- list(
    ...
    supervised_reference_contract = qa_supervised_reference_contract(),
    catboost_supervised_conformance = qa_catboost_supervised_conformance(),
    supervised_engine_conformance = qa_supervised_engine_conformance(),
